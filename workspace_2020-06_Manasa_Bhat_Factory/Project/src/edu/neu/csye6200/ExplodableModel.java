...
public class ExplodableModel extends AbstractExplodableModel {
	...
	public void explode() {
		...
		System.out.println("Exploding "+AbstractExplodableList.size()+" Explodable API explosions using factory method now!!!");
...
*/
	...
	public static void demo() {
	  ...
	  */    
	      ...
	      ExplodableAPIFactory APIfact1 = new BombExplodableAPIFactory();
	      ExplodableAPIFactory APIfact2 = new FirecrackExplodableAPIFactory();
	      ExplodableAPIFactory APIfact3 = new NuclearExplodableAPIFactory();
	      
	      objE.add(APIfact1.getObjects());
	      objE.add(APIfact2.getObjects());
	      objE.add(APIfact3.getObjects());
